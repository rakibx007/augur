...
class ContributorInterfaceable(WorkerGitInterfaceable):
    ...
    def insert_facade_contributors(self, repo_id, processes=5):
        self.logger.info(
        ...
        def process_commit_metadata(contributor):
        ...
        with Pool(processes) as commitProcessPool:
            commitProcessPool.map(process_commit_metadata, new_contribs)
